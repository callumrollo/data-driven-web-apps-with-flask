...
from pypi_org.templates.viewmodels.account.index_viewmodel import IndexViewModel
from pypi_org.templates.viewmodels.account.register_viewmodel import RegisterViewModel
